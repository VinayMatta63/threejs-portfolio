...
const Boards = ({ font, chatModel, sfModel, mfModel, fsModel, iicModel, eventsModel, loginModel, mcModel, mcLeft, mcRight, tttModel, tttLeft, }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Board, { x: -120, z: -10, text: "Social Freaks", font: font, model: sfModel, modelLeft: mfModel, modelRight: fsModel }), _jsx(Board, { x: -60, z: -40, text: "IIC DCRUST", rotation: [0, Math.PI, 0], font: font, model: iicModel, modelRight: eventsModel, modelLeft: loginModel }), _jsx(Board, { x: -120, z: -70, text: "Chat App", font: font, model: chatModel }), _jsx(Board, { x: -60, z: -140, text: "Museum Counsel", rotation: [0, Math.PI, 0], font: font, model: mcModel, modelLeft: mcLeft, modelRight: mcRight }), _jsx(Board, { x: -120, z: -140, text: "Tic Tac Toe", font: font, model: tttModel, modelLeft: tttLeft })] }));
};
